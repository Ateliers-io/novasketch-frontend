...
export const Login = () => {
    ...
    const toggle = useCallback(() => {
        ...
        tl.to(cardRef.current, { boxShadow: '0 0 60px rgba(102,252,241,.12), 0 0 0 1px rgba(102,252,241,.25), 0 40px 100px rgba(0,0,0,.5)', duration: .2 })
            ...
            // 6. settle card glow
            .to(cardRef.current, { boxShadow: '0 0 40px rgba(102,252,241,.05), 0 0 0 1px rgba(102,252,241,.12), 0 40px 100px rgba(0,0,0,.45)', duration: .3 }, '-=.15');
    ...
    const btnStyle = { background: 'linear-gradient(135deg, #2563EB 0%, #66FCF1 50%, #2563EB 100%)', backgroundSize: '200% 200%', boxShadow: '0 4px 25px rgba(102,252,241,.12), 0 0 0 1px rgba(102,252,241,.1), inset 0 1px 0 rgba(255,255,255,.15)', color: '#0B0C10' };
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0B0C10] flex items-center justify-center relative overflow-hidden p-4" style={{ fontFamily: "'Inter', sans-serif" }}>
                ...
                {/* ═══ CARD ═══ */}
                <div ref={cardRef} className="relative z-10 w-full max-w-[960px] rounded-3xl overflow-hidden" style={{ opacity: 0, minHeight: 560, backdropFilter: 'blur(20px)', background: 'linear-gradient(135deg, rgba(15,17,24,.9) 0%, rgba(11,12,16,.94) 100%)', boxShadow: '0 0 40px rgba(102,252,241,.05), 0 0 0 1px rgba(102,252,241,.12), 0 40px 100px rgba(0,0,0,.45)' }}>
