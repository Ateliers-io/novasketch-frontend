      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0B0C10]/80 backdrop-blur-lg border-b border-gray-800/50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => navigate('/auth')}
              className="px-5 py-2 rounded-lg bg-[#66FCF1] hover:opacity-90 text-black text-sm font-semibold transition-all"
            >
              Get Started
            </button>
          </div>
      ...
      <main className="relative z-10 pt-32 pb-24 px-6 max-w-6xl mx-auto">
        ...
        <section className="mb-24 text-center">
          ...
          <div className="hero-element flex flex-wrap gap-4 justify-center">
            <button
              ...
              disabled={isCreating}
              className="group h-12 px-8 rounded-xl bg-[#66FCF1] hover:opacity-90 text-black font-semibold flex items-center gap-2 transition-all shadow-lg shadow-[#66FCF1]/20 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isCreating ? (
                <>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {FEATURES.map((feat) => (
              ...
              >
                <div className={`inline-flex p-3 rounded-xl mb-6 ${feat.bg}`}>
        ...
        <section className="text-center py-16 px-8 rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700">
          ...
          <button
            onClick={handleCreateBoard}
            disabled={isCreating}
            className="h-12 px-8 rounded-xl bg-[#66FCF1] hover:opacity-90 text-black font-semibold transition-all shadow-lg shadow-[#66FCF1]/20 disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 mx-auto"
          >
            {isCreating ? (
              <>
                <Loader2 className="w-4 h-4 animate-spin" />
